...
**The status column reflects what was actually completed as of v1.5** (all v1.3 specifications are implemented and pass 577 tests; **v1.5 adds the real-session acceptance after installation**).
